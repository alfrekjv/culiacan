    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form role="form" id="reportar-persona-form" name="reportar-persona-form">
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <input type="text" class="form-control" id="nombre_completo"
                               placeholder="Escribe su nombre completo" name="nombre_completo" tabindex="17">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <textarea class="form-control" id="observaciones" name="observaciones" rows="3" tabindex="21"></textarea>
                    </div>
                </div>
            </form>
        </div>
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success reportarPersonaSubmit" tabindex="22"><span class="glyphicon glyphicon-ok-sign"></span>
                Reportar
            </button>
        </div>
    </div>
