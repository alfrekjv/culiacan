	...
	<div class="row">
		<div id="google-maps" class="col-xs-9 col-sm-9 col-md-9 col-lg-10">
			...
			<div id="btn-municipios" class="btn-group hidden-xs hidden-md">
				<button type="button" class="btn btn-primary btn-municipios btn-lg dropdown-toggle" data-toggle="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li data-filtro="<?= $row->getMunicipio(); ?>"class="<?= $row->getId() == 6 ? 'active' : ''; ?>">
						<a href="#" data-lat="<?= $row->getLat(); ?>" data-lng="<?= $row->getLng(); ?>"><?= $row->getMunicipio(); ?></a>
					</li>
					<?php endforeach; ?>
				</ul>
			</div>
		...
		<div id="sidebar" class="col-xs-3 col-sm-3 col-md-3 col-lg-2 hidden-xs">
			...
			<script>!function(e,t,n){var r,i=e.getElementsByTagName(t)[0],s=/^http:/.test(e.location)?"http":"https";if(!e.getElementById(n)){r=e.createElement(t);r.id=n;r.src=s+"://platform.twitter.com/widgets.js";i.parentNode.insertBefore(r,i)}}(document,"script","twitter-wjs")</script>
        </div>
    </div>
</div>
...
<div class="navbar navbar-inverse navbar-banderas navbar-fixed-bottom hidden-xs hidden-md" style="bottom:49px">
	<div id="btn-tipo" class="btn-group" data-toggle="buttons">
		...
		<a href="#" class="btn btn-default btn-lg" data-tipo="agua">
			<span class="glyphicon glyphicon-log-in"></span><input type="radio" name="options"> Abast. de Agua Potable
		</a>
	</div>
</div>
				...
				<ul id="list-directorio" class="list-inline text-center">
					<li>
						<a href="http://culiacan.gob.mx/" target="_blank">
							<img src="<?= $view['assets']->getUrl('images/ayuntamiento-culiacan.png'); ?>" class="img-responsive" alt="">
						</a>
					</li>
					<li>
						<a href="http://cloudadmin.mx/" target="_blank">
							<img src="<?= $view['assets']->getUrl('images/cloudadmin.png'); ?>" class="img-responsive" alt="">
						</a>
					</li>
					<li>
						<a href="http://tomatovalley.net/" target="_blank">
							<img src="<?= $view['assets']->getUrl('images/tomato-valley.png'); ?>" class="img-responsive" alt="">
						</a>
					</li>
				</ul>
				<div class="creditos">
