    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Zonas Afectadas</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Abast. de Agua Potable</a></li>
            </ul>
        </div>
        <hr class="navbar-hr">
                ...
                <ul class="dropdown-menu" role="menu">
                    <?php foreach ($municipios as $row) : ?>
                        <li data-filtro="<?= $row->getMunicipio(); ?>"
                            ...
                            <a href="#" data-lat="<?= $row->getLat(); ?>" data-lng="<?= $row->getLng(); ?>">
                                <?= $row->getMunicipio(); ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
...
<div class="navbar navbar-inverse navbar-banderas navbar-fixed-bottom hidden-xs hidden-md" style="bottom:49px">
    <div id="btn-tipo" class="btn-group" data-toggle="buttons">
        <a href="#" class="btn btn-default btn-lg" data-tipo="centros"><span
                class="glyphicon glyphicon-home"></span><input type="radio" name="options" id="option1"> Centros de
            Acopio</a>
        <a href="#" class="btn btn-default btn-lg" data-tipo="albergues"><span
                class="glyphicon glyphicon-user"></span><input type="radio" name="options" id="option2"> Albergues</a>
        <a href="#" class="btn btn-default btn-lg" data-tipo="evacuadas"><span
                class="glyphicon glyphicon-log-in"></span><input type="radio" name="options" id="option3"> Zonas
            Evacuadas</a>
        <a href="#" class="btn btn-default btn-lg" data-tipo="afectadas"><span
                class="glyphicon glyphicon-log-in"></span><input type="radio" name="options" id="option4"> Zonas
            Afectadas</a>
        <a href="#" class="btn btn-default btn-lg" data-tipo="agua"><span
                class="glyphicon glyphicon-log-in"></span><input type="radio" name="options" id="option5"> Abast. de
            Agua Potable</a>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul id="list-directorio" class="list-inline text-center">
                    <li><a href="http://culiacan.gob.mx/" target="_blank"><img
                                src="<?= $view['assets']->getUrl('images/ayuntamiento-culiacan.png'); ?>"
                                class="img-responsive" alt=""></a></li>
                    <li><a href="http://cloudadmin.mx/" target="_blank"><img
                                src="<?= $view['assets']->getUrl('images/cloudadmin.png'); ?>" class="img-responsive"
                                alt=""></a></li>
                    <li><a href="http://tomatovalley.net/" target="_blank"><img
                                src="<?= $view['assets']->getUrl('images/tomato-valley.png'); ?>" class="img-responsive"
                                alt=""></a></li>
                </ul>

                <div class="creditos">
                    <p>"La grandeza de un pueblo no se mide en su riqueza, si no en su capacidad de unirse para salir
                        adelante en situaciones difíciles" -- A Juárez.</p>

                    <p>Culiacán ha demostrado que es un pueblo muy unido y con mucho coraje ante situaciones tan
                        adversas como la presente.</p>

                    <p>Este proyecto es un homenaje para todas aquellas personas que han salido a las calles a ayudar, y
                        sobre todo, a todas las familias que lamentablemente han tenido pérdidas inmesurables.</p>
                    ...
                    <p>Nuestro objetivo es centralizar la información para apoyar en las labores de rescate, limpieza y
                        evacuación.</p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="btn-guardar-reportar-lugar" name="btn-guardar-reportar-lugar" class="btn btn-primary"
                        type="submit" data-loading-text="Espere..">Enviar Reporte
                </button>
            </div>
        </div>
    </div>
