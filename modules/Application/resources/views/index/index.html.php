...
<?php $view['slots']->start('include_css') ?>
	...
	<link href="<?= $view['assets']->getUrl('css/landing.css'); ?>" rel="stylesheet"/>
<?php $view['slots']->stop(); ?>
...
<div class="navbar navbar-inverse navbar-banderas navbar-fixed-bottom hidden-xs hidden-md" style="bottom:49px">
	<div id="btn-tipo" class="btn-group" data-toggle="buttons">
		<a href="#" class="btn btn-default" data-tipo="centros"><span class="glyphicon glyphicon-home"></span><input type="radio" name="options"> Centros de Acopio</a>
		<a href="#" class="btn btn-default" data-tipo="albergues"><span class="glyphicon glyphicon-user"></span><input type="radio" name="options"> Albergues</a>
		<a href="#" class="btn btn-default" data-tipo="evacuadas"><span class="glyphicon glyphicon-log-in"></span><input type="radio" name="options"> Zonas Evacuadas</a>
		<a href="#" class="btn btn-default" data-tipo="afectadas"><span class="glyphicon glyphicon-log-in"></span><input type="radio" name="options"> Zonas Afectadas</a>
		<a href="#" class="btn btn-default" data-tipo="agua"><span class="glyphicon glyphicon-log-in"></span><input type="radio" name="options"> Abast. de Agua Potable</a>
	</div>
</div>
...
<div class="navbar navbar-inverse navbar-fixed-bottom">
    <div class="navbar-header">
      ...
      <a href="#" class="navbar-brand"><b><span class="glyphicon glyphicon-phone-alt"></span> EMERGENCIAS 066</b></a>
    </div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
			   ...
			   <div class="creditos">
					...
					<h4 class="text-center" style="margin-top:0">Alfredo Juárez</h4>
			   </div>
