...
class Shared extends BaseController
{
    ...
    /**
     *  Get the user meta storage
     *
     * @return \UserModule\Storage\UserMeta
     */
    protected function getUserMetaStorage()
    {
        return new \UserModule\Storage\UserMeta($this->getService('DataSource'));
    }
