...
<link rel="stylesheet" href="<?php echo $view['assets']->getUrl('css/libs/bootstrap-lightbox.css') ?>" />
<?php $view['slots']->stop(); ?>

<?php $view['slots']->start('include_js_body') ?>
<script src="<?php echo $view['assets']->getUrl('js/libs/bootstrap-lightbox.js') ?>"></script>
    ...
    <div class="row">
        ...
        <div class="span4 sidebar">
            ...
            <p class="twitter-handle">
                Twitter: <a href="http://www.twitter.com/<?=$view->escape($userMeta->get('twitter')->getUserValue());?>"
                   title="@<?=$view->escape($userMeta->get('twitter')->getUserValue());?>"
                   target="_blank">@<?=$view->escape($userMeta->get('twitter')->getUserValue());?></a>
            </p>
            <?php endif; ?>
            
            <?php if($userMeta->has('facebook')): ?>
            <p class="facebook-url"><?=$view->escape($userMeta->get('facebook')->getUserValue());?></p>
            <?php endif; ?>
        ...
        <div class="span8">
            ...
            <div class="user-pictures">
                ...
                <ul class="gallery">
                    ...
                    <li>
                        <a class="gallery-element picture" href="<?=$view['assets']->getUrl('uploads/gallery/' . $picture->getFileName());?>" alt="<?=$user->getFullName();?>" data-filename='<?=$picture->getFileName();?>' data-fileid='<?=$picture->getId();?>'>
